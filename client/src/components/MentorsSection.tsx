      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex gap-6 overflow-x-auto pb-4 md:grid md:grid-cols-2 lg:grid-cols-4 md:overflow-visible">
          {mentorsContent.map((mentor) => (
            <div
              key={mentor.name}
              className="min-w-65 md:min-w-0 bg-white rounded-xl overflow-hidden border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
            >
              <img
                src={mentor.image}
                alt={mentor.name}
